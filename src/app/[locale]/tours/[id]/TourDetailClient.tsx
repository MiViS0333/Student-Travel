                                    ...
                                    <div className="row justify-content-between">
                                        <div className="col-xl-6 col-lg-7 col-sm-7 mb-24 mb-sm-0">
                                            ...
                                            <ul className="unstyled">
                                                <li className="mb-16"><p>Пункт назначения: {destination}</p></li>
                                                <li className="mb-16"><p>Место отправления: {departure}</p></li>
                                                {tour.departure_time && (
                                                    <li className="mb-16"><p>Время отправления: {isMounted ? new Date(tour.departure_time).toLocaleString(locale) : ''}</p></li>
                                                )}
                                                <li className="mb-16"><p>Возрастные ограничения: {tour.age_restriction}+</p></li>
                                                {tour.return_time && (
                                                    <li><p>Время возвращения: {isMounted ? new Date(tour.return_time).toLocaleString(locale) : ''}</p></li>
                                                )}
                                            </ul>
                                        </div>
                                        <div className="col-xl-6 col-lg-5 col-sm-5">
                                            ...
                                            <ul className="unstyled">
                                                ...
                                                {tour.max_person && (
                                                    <li className="d-flex align-items-center mb-16">
                                                        <i className="color-primary me-2 fa-light fa-user"></i><p>{tour.max_person} Человек</p>
                                                    </li>
                                                )}
                                                {tour.is_guides && (
                                                    <li className="d-flex align-items-center mb-16">
